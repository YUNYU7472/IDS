...
# ============================================================================
# Main Execution: Optimized Training (Best Params)
# ============================================================================
print("\n" + "=" * 80)
print("🎯 开始 GAT 最终训练 (使用 Trial 2 最优参数)")
print("=" * 80)
...
print(f"\n⏱️  总训练时间: {train_time:.2f}s")

# Final Evaluation
print("\n" + "=" * 80)
print("📊 最终评估结果")
print("=" * 80)
final_metrics = evaluate_full_metrics(main_model, test_dl, main_criterion)
